...
export default function RecipesFormScreen({ route, navigation }) {
  ...
  const saverecipe = async () => {
    ...
    try {
      ...
      const recipes = Array.isArray(parsedRecipes) ? parsedRecipes : [];

      // If editing a recipe, update it; otherwise, add a new one.
      if (recipeToEdit !== undefined && Number.isInteger(recipeIndex)) {
      ...
      Alert.alert("Unable to save recipe", "Please try again.");
    }
  };
